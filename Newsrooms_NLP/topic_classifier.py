## Based on the bbcsport dataset, stored in bbc_sports.db.
## Categorized by: athletics, cricket, football, rubgy, tennis. 737 documents.
...
import doc2vec.py as doc2vec_py
...
def store_into_db(data_dir, sql_dir):
